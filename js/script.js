...
(function () {
	...
	$(function () {
		...
		function attachFormValidator(elements) {
			...
			regula.custom({
				name: 'PhoneNumber',
				defaultMessage: 'El Teléfono no tiene un formato válido',
				validator: function () {
			...
			var regularConstraintsMessages = [
				...
				},
				{
					...
					newMessage: "El correo no tiene un formato válido."
				},
				{
				...
				},
				{
					...
					newMessage: "Por favor seleccione una opcion."
				}
			];
		...
		var lineChart,
				lineChartObject = {
					...
					data: {
						x: 'x',
						columns: [
							['x', '2013-01-01', '2013-06-01', '2014-01-01', '2014-05-01', '2015-01-01', '2015-06-01', '2016-01-01', '2019-01-01', '2019-06-01', '2019-09-01'],
